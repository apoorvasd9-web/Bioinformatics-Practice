# ==============================================================================
# PROJECT: Bioinformatics DNA Analyzer Pro
# PURPOSE: A comprehensive tool for analyzing DNA sequences using core Python.
# LEVEL: Beginner to Junior Data Scientist Training
# ==============================================================================

import os

# --- PHASE 4 & 5: FUNCTIONS & LAMBDA ---
...
def main_menu():
    ...
    while True:
        print("\n" + "="*40)
        print("    BIOMEDICAL DNA ANALYZER PRO v1.0")
        print("="*40)
